    ...
    public function store(Request $request)
    {
        ...
        for ($i = 1; $i <= 4; $i++) {
            ...
            DB::table('questions')->insert(
                ['questions_text' => $request->{'q1' . $i}, 'theme_id' => $themeid, 'question_type' => 'test']
            );
        ...
        DB::table('answers')->insert(
            ['questions_id' => $questionid, 'answers_text' => $request->{'a'}, 'answer_correctness' => 1]
        );
...
public function show(StudTheme $studTheme)
    ...
    public function update(Request $request, TeachTheme $teachTheme)
    {
        ...
        //fill
        DB::table('questions')->where('questions_id', '=', $request->{'question_id'})->update(
            ['questions_text' => $request->{'q'}, 'theme_id' => $teachTheme->theme_id, 'question_type' => 'fill']
        );
        //берем id вопроса для ответов
