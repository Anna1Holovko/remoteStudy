...

{
    ...
    public function pass(Request $request)
    {
        ...
        $acc = DB::table('accordance')->where('accordance_id', '=', $questionaccord)->first();
        $acc2 = DB::table('accordance')->where('accordance_id', '=', $questionaccord2)->first();
        $acc3 = DB::table('accordance')->where('accordance_id', '=', $questionaccord3)->first();
        $testing_mark = 0;
